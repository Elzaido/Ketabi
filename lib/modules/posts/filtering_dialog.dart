    ...
    return BlocConsumer<HomeCubit, HomeStates>(
      listener: (context, state){
        if(state is SuccessGetPostDataState){
          Navigator.push(context, MaterialPageRoute(builder: (context) => AllAds(title: 'إعلانات للتبديل', type: 'تبديل', fromAddPost: true)));
        }
      },
          ...
          body: Center(
            child: AlertDialog(
              content: Row(
                ...
                children: [
                  CircularProgressIndicator(color: Color.fromARGB(255, 102, 187, 106),),
                  SizedBox(width: 5,),
                  Text('جاري فلترة النتائج', style: TextStyle(
                    fontFamily: 'Cairo',
                  ),),
                ],
              ),
